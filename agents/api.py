"""
FastAPI REST API Server for Chemo Regimen Dose Safety Agent.
"""
...
app = FastAPI(
    title="Chemo Regimen Dose Safety Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "chemo-regimen-dose-safety-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
