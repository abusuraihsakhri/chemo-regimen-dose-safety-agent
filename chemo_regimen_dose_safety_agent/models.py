"""
Clinical Data Models & Enums for ChemoGuard: BSA-Adjusted Antineoplastic Regimen & Lifetime Dose Safety Agent.
...
class AgentAlert:
    ...
    guideline_citation: str = "ASCO / NCCN Antineoplastic Regimen Safety"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
