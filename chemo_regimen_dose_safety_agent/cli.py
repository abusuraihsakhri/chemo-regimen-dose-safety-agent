"""
Command-Line Interface for ChemoGuard: BSA-Adjusted Antineoplastic Regimen & Lifetime Dose Safety Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Medical Oncology | Standard: ASCO / NCCN Antineoplastic Regimen Safety")
